...
for plot_value, vals, position  in zip(unique_plots, cur_plot, legend_position):
    ...
    # test
    plt.tight_layout()
    plt.savefig(f"/home/uribe055/sedona_experiments/plots/tdb_blue/size_{plot_value}.png")  # Save the plot to a file
    # plt.close(fig)

    # final
    plt.tight_layout()
    plt.savefig(f"/home/uribe055/sedona_experiments/plots/tdb_blue/size_{plot_value}.eps")  # Save the plot to a file
    plt.close(fig)